...
public class AdapterChats  extends RecyclerView.Adapter<AdapterChats.viewHolderAdapter> {
    ...
    Context context;
    public static final int MESAJE_RIGHT= 1;
    public static final int MESAJE_LEFT= 0;
    ...
    public viewHolderAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
     if (viewType == MESAJE_RIGHT){
         View view = LayoutInflater.from(context).inflate(R.layout.chat_item_riget,parent,false);
    ...
    public void onBindViewHolder(@NonNull viewHolderAdapter holder, int position) {
        ...
        holder.tv_mesaje.setText(chats.getMensaje());
        if(soloright){
    ...
    public class viewHolderAdapter extends RecyclerView.ViewHolder {
        ...
        TextView tv_mesaje,tv_fecha;
        ImageView img_entregado,img_visto;
        public viewHolderAdapter(@NonNull View itemView) {
            super(itemView);
            tv_mesaje = itemView.findViewById(R.id.tv_mensaje);
