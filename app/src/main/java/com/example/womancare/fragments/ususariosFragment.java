 ...
 * Use the {@link ususariosFragment#newInstance} factory method to
 * create an instance of this fragment.
 */

public class ususariosFragment extends Fragment {
     ...
     * @return A new instance of fragment ususariosFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ususariosFragment newInstance(String param1, String param2) {
        ususariosFragment fragment = new ususariosFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ususarios, container, false);

        TextView tv_user=view.findViewById(R.id.tv_user);
        ImageView image_User=view.findViewById(R.id.img_user);
         progressBar = view.findViewById(R.id.progessbar);
        assert user!=null;
        tv_user.setText(user.getDisplayName());
        Glide.with(this).load(user.getPhotoUrl()).into(image_User);
